...
- [ ] Repair only the semantic-citation/source-locator compatibility boundary with exact focused proof, then deploy and perform one new zero-usage acceptance. Do not reuse the failed occurrence and do not begin U2 until U1 is green.
