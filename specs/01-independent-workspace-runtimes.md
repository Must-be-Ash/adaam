...
| 2026-08-14 | Re-prove Sprint 3 by putting deterministic SEC evaluation and versioned filing facts on the durable scheduled compiled-worker path, including terminal reservation replay | `jiti scripts/verify-sec-ipo-scheduled-compiled-worker.ts`, SEC worker/fact/fixture, schedule-budget, monitor, capability regressions, and `tsc --noEmit` — passed |
